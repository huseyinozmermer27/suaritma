...
// Veritabanından aktif sliderları çek
...
<section id="hero-slider" class="relative w-full h-[600px] md:h-[800px] overflow-hidden transition-all duration-1000 z-10">
    <div class="relative w-full h-full">
        ...
        <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out flex items-center p-4 md:p-10 hero-slide <?php echo ($index === 0) ? 'active opacity-100' : 'opacity-0'; ?>" style="<?php echo ($index === 0) ? '' : 'visibility: hidden;'; ?>">
            <div class="absolute inset-4 md:inset-10 bg-cover bg-center rounded-3xl z-10" style="background-image: url('assets/img/slider/<?php echo htmlspecialchars($s['image']); ?>');"></div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="col-span-1">
                <a href="<?php echo $base_url; ?>collections/su-aritma-cihazlari.php" class="block relative overflow-hidden rounded-xl shadow-md transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform no-underline">
            ...
            <div class="col-span-1">
                <a href="<?php echo $base_url; ?>collections/su-aritma-filtreleri.php" class="block relative overflow-hidden rounded-xl shadow-md transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform no-underline">
                    <div class="relative overflow-hidden rounded-xl">
            ...
            <div class="col-span-1">
                <a href="<?php echo $base_url; ?>collections/su-aritma-yedek-parcalari-aksesuarlari.php" class="block relative overflow-hidden rounded-xl shadow-md transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform no-underline">
                    <div class="relative overflow-hidden rounded-xl">
...
<section class="py-16 bg-gray-50 overflow-hidden" id="text-carousel-wrapper">
    ...
    <div class="w-full overflow-hidden pb-8">
        <div class="flex gap-6 animate-marquee-text w-max">
            <?php 
            // Onaylı tüm yorumları birleştiriyoruz
            $yorumlar = $db->query("
